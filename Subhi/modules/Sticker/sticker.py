...
from Subhi.core.tools import get_arg, get_text, resize_media
from Subhi.userbot import RBX


@RBX.on_message(filters.command(["stk", "kang"], hl) & filters.me)
async def kang(client: Client, message: Message):
    user = client.me
    replied = message.reply_to_message
    bunny = await edit_or_reply(message, "`cloning...`")
    media_ = None
    emoji_ = None
    is_anim = False
    is_video = False
    ...
    if replied and replied.media:
        if replied.photo:
            ...
            if not replied.sticker.file_name:
                await bunny.edit("sticker has no name..!!")
                return
            ...
            await bunny.edit("file not supported..!!")
            return
        media_ = await client.download_media(replied, file_name="Subhi/resources/")
    else:
        await bunny.edit("Reply ke Media Foto/GIF/Sticker...!!")
        return
    if media_:
        ...
        while True:
            ...
            if exist.set.count >= limit:
                ...
                await bunny.edit(
                    f"`New Sticker Pack {pack} Because the Sticker Pack is Full..!!`"
                )
                continue
            break
        if exist is not False:
            ...
            if (
                ...
                await bunny.edit(
                    "**Adding Stickers, Use @Stickers Bot to Add Your Stickers..!!**"
                )
                return
            await client.send_message("Stickers", emoji_)
            await asyncio.sleep(2)
            ...
            await bunny.edit("`Create a New Sticker Pack..!! `")
            try:
                await client.send_message("Stickers", cmd)
            except YouBlockedUser:
                await client.unblock_user("stickers")
...
@RBX.on_message(filters.command(["get", "getsticker", "mtoi"], hl) & filters.me)
